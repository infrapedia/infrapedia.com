  ...
  <div class="main-wrapper p4 pt20 pb20">
    <div class="inner-wrapper">
      ...
      <p>
        ...
        Kapany Networks, Inc. ("Network Atlas"). https://www.infrapedia.com is
      ...
      <h3>Privacy</h3>
      <p>
        Your use of https://www.infrapedia.com is subject to Network Atlas's
      ...
      <p>
        Visiting https://www.infrapedia.com or sending emails to Network Atlas
      ...
      <p>
        ...
        acknowledge that Network Atlas is not responsible for third party access
        to your account that results from theft or misappropriation of your
        account. Network Atlas and its associates reserve the right to refuse or
        cancel service, terminate accounts, or remove or edit content in our
        sole discretion.
      </p>
      <h3>Children Under Thirteen</h3>
      <p>
        Network Atlas does not knowingly collect, either online or offline,
      ...
      <p>
        ...
        Sites"). The Linked Sites are not under the control of Network Atlas and
        Network Atlas is not responsible for the contents of any Linked Site,
        including without limitation any link contained in a Linked Site, or any
        changes or updates to a Linked Site. Network Atlas is providing these
        links to you only as a This is a RocketLawyer.com document. convenience,
        and the inclusion of any link does not imply endorsement by Network
        Atlas of the site or any association with its operators.
      </p>
      ...
      <p>
        ...
        domain, you hereby acknowledge and consent that Network Atlas may share
        such information and data with any third party with whom Network Atlas
        has a contractual relationship to provide the requested product, service
        or functionality on behalf of https://www.infrapedia.com users and
        customers.
      </p>
      ...
      <p>
        ...
        to Network Atlas that you will not use the Site for any purpose that is
      ...
      <p>
        ...
        on the Site, is the property of Network Atlas or its suppliers and
      ...
      <p>
        ...
        of the content, in whole or in part, found on the Site. Network Atlas
        ...
        express written permission of Network Atlas and the copyright owner. You
        ...
        intellectual property of Network Atlas or our licensors except as
        expressly authorized by these Terms.
      </p>

      <h3>International Users</h3>
      <p>
        The Service is controlled, operated and administered by Network Atlas
        ...
        local laws. You agree that you will not use the Network Atlas Content
        accessed through https://www.infrapedia.com in any country or in any
        manner prohibited by any applicable laws, restrictions or regulations.
      </p>

      <h3>Indemnification</h3>
      <p>
        You agree to indemnify, defend and hold harmless Network Atlas, its
        ...
        Network Atlas reserves the right, at its own cost, to assume the
        exclusive defense and control of any matter otherwise subject to
        indemnification by you, in which event you will fully cooperate with
        Network Atlas in asserting any available defenses.
      </p>
      ...
      <p>
        ...
        GENERAL ACTION AGAINST THE OTHER. Further, unless both you and Network
        Atlas agree otherwise, the arbitrator may not consolidate more than one
      ...
      <p>
        Network Atlas reserves the right, in its sole discretion, to terminate
      ...
      <p>
        ...
        relationship exists between you and Network Atlas as a result of this
        agreement or use of the Site. Network Atlas's performance of this
        agreement is subject to existing laws and legal process, and nothing
        contained in this agreement is in derogation of Network Atlas's right to
        ...
        or gathered by Network Atlas with respect to such use. If any part of
      ...
      <p>
        ...
        agreement between the user and Network Atlas with respect to the Site
        ...
        Network Atlas with respect to the Site. A printed version of this
      ...
      <p>
        Network Atlas reserves the right, in its sole discretion, to change the
        ...
        Network Atlas encourages you to periodically review the Terms to stay
        informed of our updates.
      </p>
      <h3>Contact Us</h3>
      <p>
        Network Atlas welcomes your questions or comments regarding the Terms:
      </p>
      <p>
