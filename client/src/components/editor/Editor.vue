  ...
  methods: {
    ...
    handleSetMapSources(map) {
      ...
      map.on('load', function() {
        ...
        map.getSource('testpolygons').setData({
          ...
          features: [
            {
              ...
              geometry: {
                ...
                coordinates: [
                  [
                    [29.53125, 39.027718840211605],
                    [29.53125, 38.95940879245423],
                    [30.937499999999996, 39.16414104768742],
                    [31.025390625, 38.496593518947584],
                    [32.255859375, 39.07890809706475],
                    [31.003417968749996, 40.07807142745009],
                    [29.53125, 39.027718840211605]
                  ]
                ]
              }
            },
            {
              ...
              geometry: {
                ...
                coordinates: [
                  [
                    [29.68505859375, 38.66835610151506],
                    [29.663085937499996, 38.58252615935333],
                    [30.41015625, 38.06539235133249],
                    [30.73974609375, 38.788345355085625],
                    [29.68505859375, 38.66835610151506]
                  ]
                ]
              }
        ...
        map.getSource('testlines').setData({
          type: 'FeatureCollection',
          features: [
            {
              type: 'Feature',
              ...
              geometry: {
                type: 'LineString',
                coordinates: [
                  [43.41796875, 38.61687046392973],
                  [42.099609375, 40.66397287638688],
                  [40.5615234375, 40.38002840251183],
                  [39.55078125, 40.763901280945866],
                  [37.59521484375, 40.58058466412761],
                  [36.826171875, 41.02964338716638]
                ]
              }
            },
            {
              ...
              geometry: {
                type: 'LineString',
                coordinates: [
                  [30.47607421875, 40.896905775860006],
                  [34.07958984374999, 41.541477666790286]
                ]
              }
            },
            {
              ...
              geometry: {
                type: 'LineString',
                coordinates: [
                  [28.10302734375, 38.151837403006766],
                  [28.696289062499996, 36.66841891894786],
                  [31.88232421875, 36.527294814546245],
                  [34.51904296875, 37.23032838760387],
                  [36.58447265625, 37.50972584293751]
                ]
              }
            }
          ]
        })
        map.getSource('testpoint').setData({
          type: 'FeatureCollection',
          features: [
            {
              type: 'Feature',
              ...
              geometry: {
                type: 'Point',
                coordinates: [27.18017578125, 38.54816542304656]
              }
            },
            {
              type: 'Feature',
              ...
              geometry: {
                type: 'Point',
                coordinates: [32.8271484375, 40.83043687764923]
              }
            },
            {
              type: 'Feature',
              ...
              geometry: {
                type: 'Point',
                coordinates: [34.98046875, 37.666429212090605]
              }
            }
          ]
        })
