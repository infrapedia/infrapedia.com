  ...
  <transition mode="out-in" name="fade" tag="div">
    <div class="el-dialog__wrapper" v-if="visible">
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label="Sign in to infrapedia"
      >
        <div class="body-wrapper fs-regular no-selectable">
          <header class="text-center">
            <el-image class="w30" :src="imageURL" fit="scale-down" />
          </header>
          <el-divider class="m0 mt2" />
            ...
            <div class="left">
              ...
              >
                ...
                <path
                  ...
                  fill="#ccc"
                />
                <circle cx="524.99994" cy="335.5" r="16" fill="#517fc7" />
                <polygon
        ...
        <footer class="flex justify-content-end pr5">
          <el-button
            ...
            @click="signIn"
          >
            <fa :icon="['fas', 'sign-in-alt']" class="mr1" /> Sign in
          </el-button>
        </footer>
      </div>
    </div>
...
<script>
import siteFeatures from '../../config/infrapedia-features.json'
...
@import '../../assets/scss/components/promote-registration-dialog-styles.scss';
</style>
